...
describe('Testing the basic KNN functionality.', function(){
	...
	describe('The predict and predictSingle function works.', function(){
		...
		/*If you want to build the predict & predictSingle functions from scratch, without any guidance, you can leave this as an xdescribe rather than a describe.

		  However, if you implement these functions, it will be much easier to write predictSingle, and they do provide a useful way to break down the things that predictSingle will need to do.
		*/
